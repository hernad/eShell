...
<<<<<<< HEAD:src/vs/workbench/api/node/extHost.protocol.ts
// import { ITerminalSettings } from 'vs/workbench/parts/debug/common/debug';
...
>>>>>>> electron-4.0.x:src/vs/workbench/api/common/extHost.protocol.ts
