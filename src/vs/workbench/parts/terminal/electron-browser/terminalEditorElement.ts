...
export class TerminalEditorElement extends Composite {
	...
	constructor(
		...
		super( 'terminalApp', telemetryService, _themeService, storageService);
	}
...
export class TerminalEditorElementDescriptor extends CompositeDescriptor<TerminalEditorElement> {

	constructor(ctor: IConstructorSignature0<TerminalEditorElement>, id: string, name: string, cssClass?: string, order?: number, _commandId?: string) {
		super(ctor, id, name, cssClass, order, _commandId);
	}
}


export class TerminalEditorElementRegistry extends CompositeRegistry<TerminalEditorElement> {
	private defaultPanelId: string;

	/**
	 * Registers a panel to the platform.
	 */
	registerTerminalEditor(descriptor: TerminalEditorElementDescriptor): void {
	 ...
	 */
	getTerminals(): TerminalEditorElementDescriptor[] {
		return this.getComposites() as TerminalEditorElementDescriptor[];
	}
...
export const Extensions = {
	TerminalEditors: 'workbench.contributions.terminalEditorElements'
};

Registry.add(Extensions.TerminalEditors, new TerminalEditorElementRegistry());